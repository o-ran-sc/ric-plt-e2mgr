...
func (e *E2ResetRequestHandler) Handle(request models.Request) (models.IResponse, error) {
	...
	if err != nil {
		e.logger.Errorf("#E2ResetRequestNotificationHandler.Handle - failed to get status of RAN: %s from RNIB. Error: %s", resetRequest.RanName, err.Error())
