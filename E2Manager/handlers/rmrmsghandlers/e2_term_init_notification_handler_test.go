...
//	_, handler, readerMock, writerMock, rmrMessengerMock, _ := initRanLostConnectionTest(t)
//	var rnibErr error
//
...
//	log, handler, readerMock, writerMock, rmrMessengerMock, _ := initRanLostConnectionTest(t)
//	var rnibErr error
//
