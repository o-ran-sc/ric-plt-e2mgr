...
func TestNewE2nodeConfigurationUpdateSuccessResponseMessage(t *testing.T) {
	...
	assert.Equal(t, "10", successOutcome.ProcedureCode)
	...
	assert.Equal(t, "52", additionIE.ID)
	...
	assert.Equal(t, "56", removalIE.ID)
