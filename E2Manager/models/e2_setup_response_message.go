...
func NewE2SetupFailureResponseMessage() E2SetupResponseMessage{
	outcome := UnsuccessfulOutcome{}
	outcome.Value.E2setupFailure.ProtocolIEs.E2setupFailureIEs = make([]E2setupFailureIEs, 1)
	outcome.ProcedureCode = "1"
	outcome.Value.E2setupFailure.ProtocolIEs.E2setupFailureIEs[0].ID = "4"
	return E2SetupResponseMessage{E2APPDU:E2APPDU{Outcome:outcome}}
}
