...
func TestRicServiceQueryMessageSuccess(t *testing.T) {
	...
	assert.Equal(t, "49", initMsg.Value.RICServiceQuery.ProtocolIEs.RICServiceQueryIEs[0].Id)
	assert.Equal(t, "9", initMsg.Value.RICServiceQuery.ProtocolIEs.RICServiceQueryIEs[1].Id)
